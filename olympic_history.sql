...
--1.team that won the maximum gold medals over the years
...
--3.player that won maximum gold medals  amongst the players 
...
--Query to display year,player name and no of golds won in that year . 
...
--8.players who have won gold medals in consecutive 3 summer olympics in the same event.
